...
CheckerHubWorld::CheckerHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void CheckerHubWorld::SetUpLevel()
{
	moveDownHeight = -30;
...
void CheckerHubWorld::UpdateParticlesPos()
{
...
void CheckerHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void CheckerHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void CheckerHubWorld::CheckOutOfBounds()
{
...
void CheckerHubWorld::CreatePlayer()
{
...
void CheckerHubWorld::SetUpParticles()
{
...
void CheckerHubWorld::CalculateCamPos(float dt)
{
...
void CheckerHubWorld::SetUpActions()
{
