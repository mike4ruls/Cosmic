...
RainbowHubWorld::RainbowHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void RainbowHubWorld::SetUpLevel()
{
	moveDownHeight = -30;
...
void RainbowHubWorld::UpdateParticlesPos()
{
...
void RainbowHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void RainbowHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void RainbowHubWorld::CheckOutOfBounds()
{
...
void RainbowHubWorld::CreatePlayer()
{
...
void RainbowHubWorld::SetUpParticles()
{
...
void RainbowHubWorld::CalculateCamPos(float dt)
{
...
void RainbowHubWorld::SetUpActions()
{
