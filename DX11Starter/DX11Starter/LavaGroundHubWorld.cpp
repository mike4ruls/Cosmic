...
LavaGroundHubWorld::LavaGroundHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void LavaGroundHubWorld::SetUpLevel()
{
	moveDownHeight = -30;
...
void LavaGroundHubWorld::UpdateParticlesPos()
{
...
void LavaGroundHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void LavaGroundHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void LavaGroundHubWorld::CheckOutOfBounds()
{
...
void LavaGroundHubWorld::InitUI()
{
...
void LavaGroundHubWorld::CreatePlayer()
{
...
void LavaGroundHubWorld::SetUpParticles()
{
...
void LavaGroundHubWorld::CalculateCamPos(float dt)
{
...
void LavaGroundHubWorld::SetUpActions()
{
