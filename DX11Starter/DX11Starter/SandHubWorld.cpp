...
SandHubWorld::SandHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void SandHubWorld::UpdateParticlesPos()
{
...
void SandHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void SandHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void SandHubWorld::CheckOutOfBounds()
{
...
void SandHubWorld::CreatePlayer()
{
...
void SandHubWorld::SetUpParticles()
{
...
void SandHubWorld::CalculateCamPos(float dt)
{
...
void SandHubWorld::SetUpActions()
{
