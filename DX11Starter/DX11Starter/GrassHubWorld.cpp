...
GrassHubWorld::GrassHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void GrassHubWorld::UpdateParticlesPos()
{
...
void GrassHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void GrassHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void GrassHubWorld::CheckOutOfBounds()
{
...
void GrassHubWorld::CreatePlayer()
{
...
void GrassHubWorld::SetUpParticles()
{
...
void GrassHubWorld::CalculateCamPos(float dt)
{
...
void GrassHubWorld::SetUpActions()
{
