...
LavaHubWorld::LavaHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void LavaHubWorld::UpdateParticlesPos()
{
...
void LavaHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void LavaHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void LavaHubWorld::CheckOutOfBounds()
{
...
void LavaHubWorld::CreatePlayer()
{
...
void LavaHubWorld::SetUpParticles()
{
...
void LavaHubWorld::CalculateCamPos(float dt)
{
...
void LavaHubWorld::SetUpActions()
{
