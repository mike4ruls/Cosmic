...
BrickHubWorld::BrickHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void BrickHubWorld::UpdateParticlesPos()
{
...
void BrickHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void BrickHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void BrickHubWorld::CheckOutOfBounds()
{
...
void BrickHubWorld::CreatePlayer()
{
...
void BrickHubWorld::SetUpParticles()
{
...
void BrickHubWorld::CalculateCamPos(float dt)
{
...
void BrickHubWorld::SetUpActions()
{
