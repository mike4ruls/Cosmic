...
WaterHubWorld::WaterHubWorld(CosmicEngine* eng)
{
	engine = eng;
	cam = new FreeCamera();
}
...
void WaterHubWorld::UpdateParticlesPos()
{
...
void WaterHubWorld::CheckInputs(float dt)
{
	if (!p1->isDead) {
...
void WaterHubWorld::CheckControllerInputs(float dt)
{
	if (!p1->isDead) {
		bool butCheckX = false;
		bool butCheckY = false;
...
void WaterHubWorld::CheckOutOfBounds()
{
...
void WaterHubWorld::CreatePlayer()
{
...
void WaterHubWorld::SetUpParticles()
{
...
void WaterHubWorld::CalculateCamPos(float dt)
{
...
void WaterHubWorld::SetUpActions()
{
